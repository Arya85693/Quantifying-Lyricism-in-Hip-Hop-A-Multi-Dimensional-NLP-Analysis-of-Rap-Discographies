"""
Ingestion script for Drake's discography.
"""
...
def ingest_drake():
    """Main ingestion function for Drake."""
    artist_name = "Drake"
    output_file = Path(RAW_DATA_DIR) / "drake_lyrics.jsonl"
    log_file = Path(RAW_DATA_DIR) / "ingestion_errors_drake.log"
