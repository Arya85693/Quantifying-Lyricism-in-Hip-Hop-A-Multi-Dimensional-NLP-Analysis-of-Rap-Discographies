"""
Ingestion script for Kendrick Lamar's discography.
"""
...
def ingest_kendrick_lamar():
    """Main ingestion function for Kendrick Lamar."""
    artist_name = "Kendrick Lamar"
    output_file = Path(RAW_DATA_DIR) / "kendrick_lamar_lyrics.jsonl"
    log_file = Path(RAW_DATA_DIR) / "ingestion_errors_kendrick_lamar.log"
    ...
    # Get all songs
    songs = get_artist_songs(artist_id, per_page=50, max_pages=10)
