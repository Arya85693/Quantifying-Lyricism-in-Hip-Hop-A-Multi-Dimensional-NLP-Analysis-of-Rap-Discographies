"""
Ingestion script for Kanye West's discography.
"""
...
def ingest_kanye_west():
    """Main ingestion function for Kanye West."""
    artist_name = "Kanye West"
    output_file = Path(RAW_DATA_DIR) / "kanye_west_lyrics.jsonl"
    log_file = Path(RAW_DATA_DIR) / "ingestion_errors_kanye_west.log"
