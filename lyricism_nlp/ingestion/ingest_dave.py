"""
Ingestion script for Dave's discography.
"""
...
def ingest_dave():
    """Main ingestion function for Dave."""
    artist_name = "Dave"
    output_file = Path(RAW_DATA_DIR) / "dave_lyrics.jsonl"
    log_file = Path(RAW_DATA_DIR) / "ingestion_errors_dave.log"
